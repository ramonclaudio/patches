...
| :------------------------------------------------------------- | :------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------- |
| [`react-native`](packages/react-native/)                       | n/a                              | Add the missing `react/bridging/ArrayBuffer.h` include in the TurboModule ArrayBuffer test so `yarn test-ios` compiles on OSS main.                                                                                                                                                                    | merged ([react/react-native#57518](https://github.com/react/react-native/pull/57518))                                              |
| [`expo`](packages/expo/)                                       | n/a                              | Surface the real `xcodebuild` error lines when `expo run:ios` fails but the log formatter parsed none, instead of `0 error(s)` and a raw 15k-line dump.                                                                                                                                                | merged ([expo/expo#47748](https://github.com/expo/expo/pull/47748))                                                                |
